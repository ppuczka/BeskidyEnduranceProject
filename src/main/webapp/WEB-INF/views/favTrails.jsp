...
<div id="page-content-wrapper">
    <div id="wrapper">
        ...
        <table class="table table-hover">
            <div class="tableTitle">Ulubione trasy</div>
            <thead>
            <tr>
                <th>Ranking</th>
                <th>Nazwa</th>
            ...
            <tbody>
            <c:forEach items="${favTrails}" var="trail">
                <tr>
                    <td>${trail.rating}</td>
                    <td>${trail.name}</td>
                    ...
                    <td><a href="/logged/trails/deleteTrail/${trail.trailId}" role = "button" class="btn btn-primary btn-sm"><i class="fas fa-trash-alt"></i></a>
                        <a href="/logged/trails/disLikeTrail/${trail.trailId}" role = "button" class="btn btn-primary btn-sm"><i class="fas fa-thumbs-down"></i></a>
